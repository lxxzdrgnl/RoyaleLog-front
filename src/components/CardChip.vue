...
defineProps<{
  card: { id: number; name: string; level: number; evolutionLevel: number; elixirCost: number; iconUrl: string }
  size?: 'sm' | 'md' | 'lg'
}>()
</script>
...
.chip img { display: block; object-fit: contain; width: 100%; height: 100%; }
.chip-level {
